        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <?php
						$query = "SELECT LPAD(id_categoria, 4, '0') AS id_categoria, imagen, nombre, descripcion FROM categorias WHERE id_categoria = '$id'";
                                    ...
                                    <form id="update-category" action="inc/update-category.php" method="POST"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="number" name="id" class="form-control" placeholder="1020"
                                                    value="<?php echo $row['id_categoria'] ?>" disabled>
                                                <input type="number" name="id" class="form-control"
                                                    value="<?php echo $row['id_categoria'] ?>" hidden>
                                            </div>
                                            <div class="form-group col-md-10">
                                                <label class="form-label">Nombre de la Categoría</label>
                                                <input type="text" name="nombre" class="form-control"
                                                    placeholder="Calzado" value="<?php echo $row['nombre'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <a href="/sisvent/all-categories.php" class="btn btn-secondary">Ver Categorías</a>
                                    </form>
                                </div>
                            </div>
                        </div>
