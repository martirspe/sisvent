                        ...
                        <div class="col-12 col-xl-12">
                            <div class="card">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php
										$query = "SELECT LPAD(id_categoria, 4, '0') AS id_categoria, imagen, nombre, descripcion FROM categorias WHERE estado = 1 ORDER BY nombre ASC";
                                        ...
                                        <td class="text-center" colspan="4"><i class="align-middle mr-1"
